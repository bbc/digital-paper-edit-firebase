...
const awaitForDomChange = container =>
...
describe('App component', () => {
  ...
  it('renders with projects', async () => {
    ...
    const emptyMessage =
      'There are no Projects, create a new one to get started.';
    ...
    const description =
      'Interviews from PBS Frontline documentary, The Facebook Dilemma - sample project.';
