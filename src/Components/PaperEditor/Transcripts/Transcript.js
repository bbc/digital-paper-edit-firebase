...
//   let videoRef = useRef()
//   const collection = new Collection(props.firebase, );
...
//   const [showParagraphsMatchingSearch, setShowPMS] = useState(false)
//   const [selectedOptionLabelSearch, setSOLS] = useState(false)
//   const [selectedOptionSpeakerSearch, setSOLS] = useState([])
//   const [sentenceToSearchCSS, setSTSC] = useState('')
//   const [sentenceToSearchCSSInHighlights, setSTSCIH] = useState('')
//   const [annotations, setAnnotations] = useState([])
//   const [isLabelsListOpen, setILLO] = useState(true)
...
//   const handleShowParagraphsMatchingSearch = () => {
//     this.setState(state => {
//       return {
...
//   const handleSpeakersSearchChange = selectedOptionSpeakerSearch => {
//     this.setState({
//       selectedOptionSpeakerSearch
//     });
//   };

//   const handleSearch = (e, searchPreferences) => {
...
//   const highlightWords = searchString => {
